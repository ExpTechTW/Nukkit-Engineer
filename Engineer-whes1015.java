...
public class whes1015 extends PluginBase implements Listener {
    ...
    public String a="";
    private final int vercode=104;
    private final String vername="V 1.0.4-stable";
    ...
    public void onEnable() {
        ...
        URL url = null;
        try {
            url = new URL("http://220.134.162.44:81/whes1015fix.php");
        ...
        try {
            ...
            if(vercode < x) {
                ...
                this.getLogger().info(TextFormat.BLUE + "Engineer whes1015 Update Checking Success! "+vername);
        ...
        this.getLogger().info(TextFormat.BLUE + "Engineer whes1015 Loading! "+vername);
    ...
    public void onDisable() {
        this.getLogger().info(TextFormat.BLUE + "Engineer whes1015 Closing! VersionName:"+vername+" VersionCode:"+vercode);
    }
    ...
    public void PlayerInteractEvent(PlayerInteractEvent event) {
        ...
        }else if(event.getBlock().getId()==147){
            event.getPlayer().kick("無法連接至世界",false);
        }
